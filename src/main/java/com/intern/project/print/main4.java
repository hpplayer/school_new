...
public class main4 implements Printable {
private TableModel table;
private String title;

public main4 (JTable table, String title) {
...
//g2d.drawString (table. getColumnName (i), i * 100,40);
	g2d.drawString (table. getColumnName (i), i*115,40);
}
...
//g2d.drawString (cell, ii * 100,60 + i * 20);
	g2d.drawString (cell, ii * 115,80 + i * 20);
}
}
